    ...
    <div class="video">
        ...
        <div class="content">
            <video controls style="width: 100%;"> <!-- Set fixed height for the video -->
                <source src="WhatsApp Video 2024-03-09 at 02.19.18_55a14d10.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div><br>
        <!-- Video details --> 
        <div class="play-details-section">
            <h2>Reunited Friendship (Funny Videos)</h2>
            <strong></strong><p>Hey guys hope u all love ❤this vedio and give it your love support😇 and make sure to like, share & subscribe
</p>
        </div>
    </div>
