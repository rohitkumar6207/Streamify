...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name) || empty($email) || empty($cardNumber) || empty($expiry) || empty($cvv)) {
        ...
        $sql = "INSERT INTO  `subscriptions_3` (name, email, cardNumber,expiry , cvv) VALUES ('$name', '$email', '$cardNumber', '$expiry', '$cvv')";
...
<body background="z6btu437zgi91.webp">
  ...
  <div class="container_payment">
    <h1>Payment for Premium Subscription (₹999)</h1>
    <form method="POST">
      ...
      <input type="submit" value="Pay ₹999">
    </form>
  </div>
</body>
</html>
