    ...
    <div class="video">
        ...
        <div class="content">
            <video controls style="width: 100%;"> <!-- Set fixed height for the video -->
                <source src="[4K]_One_Piece「AMV_Edit」_Royalty_(1080p60).mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div><br>
        <!-- Video details --> 
        <div class="play-details-section">
            <h2>One Piece - Set Fire to the Rain (AMV Edit)</h2>
            <p>One Piece: Kimetsu no Yaiba - Set Fire to the Rain (AMV Edit) in 4K resolution.</p>
            <strong>Plot:</strong><p>ONE PIECE is a legendary high-seas quest unlike any other. Luffy is a young adventurer who has longed for a life of freedom ever since he can remember. He sets off from his small village on a perilous journey to find the legendary fabled treasure, ONE PIECE, to become King of the Pirates!</p>
        </div>
    </div>
